...
from gendp.policy.act_policy import ACTPolicy
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if (self.epoch % cfg.training.sample_every) == 0:
                    with torch.no_grad():
                        ...
                        pred_action = result['action_pred']
                        all_mse = torch.nn.functional.mse_loss(pred_action, gt_action, reduction='none')
                        mse = (all_mse * ~is_pad.unsqueeze(-1)).mean()
