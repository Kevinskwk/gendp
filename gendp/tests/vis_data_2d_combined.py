...
for i in epi_range:
    ...
    combine_image_arrays_to_video_2x3(
        data_dict['observations']['images']['camera_front_depth'],
        data_dict['observations']['images']['camera_left_depth'],
        data_dict['observations']['images']['camera_front_color'],
        data_dict['observations']['images']['camera_left_color'],
        # np.stack(marker_flow_left_imgs),
        # np.stack(marker_flow_right_imgs)
        data_dict['observations']['tactile']['tactile_img_left'],
        data_dict['observations']['tactile']['tactile_img_right']
    )
