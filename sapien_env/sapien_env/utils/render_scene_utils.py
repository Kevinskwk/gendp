...
# from sapien.pysapien import renderer as R

from sapien_env.utils.mesh_utils import compute_smooth_shading_normal_np

Vector3dVector = o3d.utility.Vector3dVector
Vector3iVector = o3d.utility.Vector3iVector


# def segment_articulation_from_mask(segmentation: np.ndarray, articulation: sapien.physx.PhysxArticulation):
...
#             render_body_mesh.translate(-half_size)
...
# def actor_to_open3d_mesh(actor: sapien.Entity, use_collision_mesh=False, use_texture=False, use_actor_pose=False):
#     meshes = []
...
# def set_entity_visibility(entities: List[Union[sapien.ActorBase, sapien.physx.PhysxArticulation]], visibility: float):
#     for entity in entities:
#         if isinstance(entity, sapien.ActorBase):
#             for geom in entity.get_visual_bodies():
#                 geom.set_visibility(visibility)
#         elif isinstance(entity, sapien.physx.PhysxArticulation):
...
# def set_entity_color(entities: List[Union[sapien.ActorBase, sapien.physx.PhysxArticulation]], color: List[float]):
#     if len(color) != 4:
...
# def add_mesh_to_renderer(scene: sapien.Scene, renderer: sapien.SapienRenderer, vertex: np.ndarray, faces: np.ndarray,
...
# def add_line_set_to_renderer(scene: sapien.Scene, renderer: sapien.SapienRenderer, position: np.ndarray,
