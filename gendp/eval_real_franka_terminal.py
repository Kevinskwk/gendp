...
@click.option('--task', '-t', default='scraper', type=click.Choice(['scraper', 'crayon', 'peeler'], case_sensitive=False), help="Task name for initial pose (scraper, crayon, or peeler)")
